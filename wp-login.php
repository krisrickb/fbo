...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	?>
        ...
        <style>
            .login h1 a {
                background-image: none,url(/wp-content/themes/fbo/img/foodbenders_gr_001.png);
            ...
            p.titletag{
                text-align: center;
                font: small-caps bold 1.25em/140% Verdana, sans-serif;
            }
        </style>
	...
	<p class="titletag">- welcome to our online ordering system - <br />please log in below</p>
        <?php
